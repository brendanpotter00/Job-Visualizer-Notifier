...
export const COMPANIES: Company[] = [
  ...
  createGreenhouseCompany('blackforestlabs', 'Black Forest Labs'),
  createGreenhouseCompany('fal', 'Fal'),
  createGreenhouseCompany('heygen', 'HeyGen'),
  createGreenhouseCompany('sambanovasystems', 'SambaNova'),
  createGreenhouseCompany('thinkingmachines', 'Thinking Machines Lab'),
  createGreenhouseCompany('togetherai', 'Together AI'),
  createGreenhouseCompany('worldlabs', 'World Labs'),
  ...
  createLeverCompany('mistral', 'Mistral AI'),
  // Ashby companies
  ...
  createAshbyCompany('abridge', 'Abridge', { jobBoardName: 'Abridge' }),
  createAshbyCompany('chaidiscovery', 'Chai Discovery'),
  createAshbyCompany('clay', 'Clay', { jobBoardName: 'claylabs' }),
  createAshbyCompany('cognition', 'Cognition'),
  createAshbyCompany('crusoe', 'Crusoe', { jobBoardName: 'Crusoe' }),
  createAshbyCompany('gamma', 'Gamma'),
  createAshbyCompany('krea', 'Krea'),
  createAshbyCompany('legora', 'Legora'),
  createAshbyCompany('listenlabs', 'Listen Labs'),
  createAshbyCompany('lovable', 'Lovable'),
  createAshbyCompany('mercor', 'Mercor'),
  createAshbyCompany('physicalintelligence', 'Physical Intelligence'),
  createAshbyCompany('reflectionai', 'Reflection'),
  createAshbyCompany('replit', 'Replit'),
  createAshbyCompany('rogo', 'Rogo', { jobBoardName: 'Rogo' }),
  createAshbyCompany('runway', 'Runway'),
  createAshbyCompany('sierra', 'Sierra', { jobBoardName: 'Sierra' }),
  createAshbyCompany('speak', 'Speak'),
  createAshbyCompany('ssi', 'Safe Superintelligence'),
  createAshbyCompany('suno', 'Suno'),
  createAshbyCompany('synthesia', 'Synthesia'),

  // Gem companies
  createGemCompany('nominal', 'Nominal'),
  createGemCompany('retool', 'Retool'),
  createGemCompany('gem', 'Gem'),
  createGemCompany('genspark', 'Genspark'),
