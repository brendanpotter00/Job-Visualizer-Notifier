/**
 * Mock job data for the landing page.
 *
 * The page is frontend-only: nothing here fetches. Jobs use REAL company ids
 ...
 * drift as a long-lived tab ages — acceptable while the page is mock-backed.
 */
