 ...
 *
 * Placement contract: render it as the FIRST child of a prototype's root box,
 ...
 * its own containing block is in view — so nesting it inside Gravity's or
 * Drift's clipped hero wrapper would scroll it away with the hero. Sitting
