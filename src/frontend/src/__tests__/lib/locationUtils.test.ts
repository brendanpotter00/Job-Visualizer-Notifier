...
describe('locationUtils', () => {
  ...
  describe('US_STATE_NAME_TO_CODE / helpers', () => {
    it('reverse-maps full state names to codes (case-insensitive key)', () => {
      expect(US_STATE_NAME_TO_CODE['CALIFORNIA']).toBe('CA');
      expect(US_STATE_NAME_TO_CODE['TEXAS']).toBe('TX');
