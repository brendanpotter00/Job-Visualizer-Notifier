...
const SM_DESKTOP: Record<string, number | string> = {
  ...
  'landingProto.sectionTitleFontSize': '2rem',
  'landingProto.eyebrowFontSize': '0.8125rem',
  'landingProto.statValueFontSize': '3.5rem',
  'landingProto.comparisonRowPaddingY': 3,
  'landingProto.closingHeadingFontSize': '2.5rem',
