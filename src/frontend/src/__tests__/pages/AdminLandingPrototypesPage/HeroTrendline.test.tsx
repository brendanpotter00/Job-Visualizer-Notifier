...
import { HeroTrendline } from '../../../pages/AdminLandingPrototypesPage/sections/HeroTrendline';
import { buildSmoothPath } from '../../../pages/AdminLandingPrototypesPage/sections/trendlinePath';
