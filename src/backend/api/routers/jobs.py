...
# unbounded `IN`-list scans. The Recent Jobs page currently fans out to ~49
# backend-scraper companies; 100 leaves headroom without inviting abuse.
_MAX_COMPANIES_PER_REQUEST = 100
