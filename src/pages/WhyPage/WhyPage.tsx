      ...
      <Box sx={{ my: 4 }}>
        ...
        <Paper sx={{ p: 3, mb: 4 }}>
          <Typography variant="body1" component="p" sx={{ mb: 2 }}>
            I made this platform because the best way to get job interviews is to apply early. Other job platforms are bloated
              with random companies and stale job listings that were really posted weeks ago.
          </Typography>
            <Typography variant="body1" component="p" sx={{ mb: 2 }}>
                So I created this platform. It pulls directly from the company's job postings and top companies. No more shifting through no-name
                companies or wondering if the job listing is actually new.
            </Typography>
            <Typography variant="body1" component="p" sx={{ mb: 2 }}>
            The best way to get interviews is to either apply earlier or reach out to the hiring manager or recruiters, especially in this job market.
            </Typography>
            ...
            <Typography variant="body1" component="p" sx={{ mb: 2 }}>
               Feel free to reach out to me to suggest new companies, features, or give any other feedback.
            </Typography>
            <Link
