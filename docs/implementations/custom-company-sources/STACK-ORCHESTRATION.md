...
| P3 | `feat/e7-phase3-discovery` | P2 | **#248** | Phase 3 — closed primitive vocabulary + stored scripts + one-time local-Playwright agent discovery (§6 Phase 3, §9) | ✅ implemented + reviewed (SSRF fixed) · discovery confirmed live · PR open |
| P4 | `feat/e7-phase4-browser-runtime` | P3 | — | Phase 4 — Browserbase runtime + execution-time SSRF/CDP host pinning (§6 Phase 4) | ⏳ queued — Browserbase (free-tier key in `.env.local`). Article gate LIFTED 2026-08-09 (Brendan: no articles). |
